								...
								{product.nickname == "Unlimited"
									...
									: product.nickname == "Pro"
										...
										: product.nickname == "Free" &&
											"Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into Automaton's automation capabilities."}
							</CardDescription>
